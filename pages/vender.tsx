                ...
                <div className='relative w-full h-full  md:w-2/5 bg-white rounded-sm p-2 flex flex-col justify-evenly items-center'>
                    <div className='mb-5'>
                        <div className='w-full flex items-center justify-center py-5'>
                            <Image src='/Basket.svg' width='48px' height='48px' />
                        </div>
                        <p className='dop-text text-xs font-medium text-center'>
                            Por favor indique los datos solicitados a continuación para proceder con el inicio de su orden de venta
                        </p>
                    </div>
                    {/*  */}
                    <div className='form-container'>
                        <DopSelect
                            label='¿Qué activo desea comprar?'
                            options={[
                                {
                        ...
                        <label className='flex items-center w-full md:w-60 px-3 py-2  my-5 bg-gray-200 rounded-sm'>
                            <input type='text' className='bg-transparent outline-none w-full h-full text-xs text-gray-900' placeholder='Ingrese su cédula' />
