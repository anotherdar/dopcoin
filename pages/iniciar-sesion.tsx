        ...
        <AccountLayout title='Iniciar sesion'>
            <motion.div animate={{y: [1000, 0]}} className='bg-blue-700 p-2 mt-10 rounded-lg h-5/6 xl:w-3/5 w-11/12 md:flex shadow-lg mb-20'>
                ...
                <div className='relative w-full h-full md:w-2/5 bg-white rounded-sm shadow-md flex flex-col justify-evenly items-center'>
                    ...
                    <div className='text-center p-2 pt-4 md:py-10'>
                        <h1 className='text-blue-700 font-semibold text-lg'>Iniciar sesión</h1>
                        <p className='md:hidden text-xs text-gray-800'>Bienvenido de vuelta</p>
                    </div>
                    <div className='px-5 w-full text-center'>
                        <label className='flex items-center border-b-2 border-blue-600 p-2 mb-7 bg-gray-200 rounded-sm'>
